...
\keywordsEN{Approximate Pattern Matching, Exact Pattern Matching, Locality Sensitive Hashing, SciDB, Regular Grinds on Arrays, Multidimensional Arrays}
...
\begin{figure}
	\dirtree{%
		...
		.1 scripts\DTcomment{the directory with Python scripts}.
		.1 include\DTcomment{the directory with header C++ files}.
		.1 src\DTcomment{the directory of source codes}.
		.1 text\DTcomment{the thesis text directory}.
		.2 DP\_Kucerova\_Anna\_2017.pdf\DTcomment{the thesis text in PDF format}.
		.2 DP\_Kucerova\_Anna\_2017.tex\DTcomment{the thesis text in TEX format}.
		.2 img\DTcomment{folder with images used in text}.
	}
\end{figure}
