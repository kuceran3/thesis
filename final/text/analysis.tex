...
Another section is devoted to introduction of the scientific database SciDB \ref{scidb} with its binary data format and some possible ways of working with its data.
...
Hashing approach is based on transforming the data item into a low-di\-men\-sio\-nal representation or a short code composed of a sequence of bits.
...
In machine learning, recent research is focused on leveraging data-de\-pen\-dent and task-specific information for improving efficiency of hash functions like this. Some of the examples are: using kernel learning with LSH \cite{kernelLSH}, boosted LSH \cite{boostLSH} and non-metric LSH \cite{nonMLSH}.
