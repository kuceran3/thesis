...
all: brute brute2 brute_chunks appbrute_chunks exactSkipDim exactSkipDim_chunks exactSkipDim2 appSplitDyn appSplitDyn2 appSplitDyn_chunks stricterFilter_chunks clean
